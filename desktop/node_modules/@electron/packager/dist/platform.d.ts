...
import { createAsarOpts } from './common.js';
...
export declare class App {
    ...
    get commonHookArgs(): {
        ...
        platform: import("./types.js").OfficialPlatform;
        arch: import("./types.js").OfficialArch;
    };
    ...
    prebuiltAsarWarning(option: keyof ProcessedOptionsWithSinglePlatformArch, triggerWarning: unknown): void;
