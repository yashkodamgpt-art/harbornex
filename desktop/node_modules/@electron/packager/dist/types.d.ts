...
export type FinalizePackageTargetsHookFunction = (targets: TargetDefinition[]) => void | Promise<void>;
/** See the documentation for [`@electron/osx-sign`](https://npm.im/@electron/osx-sign#opts) for details.
 * @interface
 */
export type PackagerOsxSignOptions = Omit<OSXSignOptions, 'app' | 'binaries' | 'platform' | 'version'>;
/**
 * See the documentation for [`@electron/universal`](https://github.com/electron/universal)
 * for details.
 * @interface
 */
export type PackagerUniversalOptions = Omit<MakeUniversalOpts, 'x64AppPath' | 'arm64AppPath' | 'outAppPath' | 'force'>;
/**
 * @internal
 */
